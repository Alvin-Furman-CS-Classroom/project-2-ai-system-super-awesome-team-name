...
class TestFoodSafetyIntegration(unittest.TestCase):
    ...
    def test_low_gi_food_safe(self):
        ...
        result = self.engine.evaluate_food("cabbage")
    ...
    def test_case_insensitive_lookup(self):
        ...
        r2 = self.engine.evaluate_food("cabbage")
    ...
    def test_invalid_serving_raises(self):
        ...
        with self.assertRaises(ValueError):
            self.engine.evaluate_food("cabbage", "invalid")
